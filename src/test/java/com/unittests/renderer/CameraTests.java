...
public class CameraTests {
    ...
    void testConstructRay() {
        ...
        assertEquals(new Ray(Point.ZERO, new Vector(1, -1, -10)),
                     camera.setSize(8, 8).constructRay(4, 4, 1, 1),
                     badRayErrorMessage);
