...
public class LightsTests {
    ...
    private final Scene
        scene2
        = new Scene("Test scene").setAmbient(new AmbientLight(new Color(WHITE), new Double3(0.15)));
    private final Camera camera1 = new Camera(new Point(0, 0, 1000),
        new Vector(0, 0, -1),
        new Vector(0, 1, 0)).setSize(150, 150).setDistance(1000);
    private final Camera camera2 = new Camera(new Point(0, 0, 1000),
        new Vector(0, 0, -1),
        new Vector(0, 1, 0)).setSize(200, 200).setDistance(1000);
    ...
    private final Geometry sphere = new Sphere(new Point(0, 0, -50),
        50d).setEmission(new Color(BLUE).reduce(2))
    ...
    public void sphereSpot() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5)).setKL(0.001)
                                                                           .setKQ(0.0001));
    ...
    public void sphereSpotSharp() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5)).setNarrowBeam(10)
                                                                           .setKL(0.001)
                                                                           .setKQ(0.00004));
    ...
    public void trianglesSpotSharp() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(trCL, trPL, trDL).setNarrowBeam(10)
                                                         .setKL(0.001)
                                                         .setKQ(0.00004));
