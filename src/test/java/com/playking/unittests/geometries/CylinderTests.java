...
public class CylinderTests {
    ...
    void findIntersections() {
        ...
        assertEquals(List.of(new Point(2.5, 0, 0), new Point(2.5, 0, 2)), result,
        ...
        result = cylinder.findIntersections(ray);
        assertEquals(2, result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(3, 0, 0.5), new Point(1, 0, 0.5)), result,
        ...
        result = cylinder.findIntersections(ray);
        assertEquals(2, result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(3, 0, 1), new Point(2, 0, 0)), result,
                     "Bad intersection points");
